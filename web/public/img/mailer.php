...
$translation=array(
	'ru'=>array(
		...
		'settings-outservers-doc'=>'????????? ???????? ?????? ? ???????? ????????? ???????? ? <a href="http://mailer.a-l-e-x-u-s.ru/docs/alexusMailer_v1.7.ru.pdf"><span class="label label-warning">????????????</span></a>',
		'settings-outservers-check'=>'<button class="btn" onclick="pingoutservers()">????????? ???????</button> (??????????? ????? ????????????? ??????? ?? ??????)',
		'settings-outservers-check-log'=>'??? ????????:',
		'settings-security-notwritable'=>' ??????????? ?????? ?? ?????? ? ???????! ????? ?????? ??????????. <b>???????? ????? ?? 666</b> ?? ????? ????? ??????.',
		'settings-security-password-changed'=>'?????? ??????? ???????!',
		'settings-security-password-not-changed'=>'??? ????????? ?????? ????????? ??????, ???????? ???? ??????? ?????????? ?? ??????.',
		'settings-security-set-password'=>'?????????? ??????',
		'settings-security-remove-password'=>'??????? ??????',
		'settings-security-use-proxy'=>'???????????? http ??????',
		'main'=>'???????',
		'help'=>'??????',
		'login'=>'?????',
		'password'=>'??????',
		...
		'title_service'=>'?????? ????????? ???????? ????? ? ???????? ??????',
		'description_service'=>'?????? ????????? ???????? ??????????? ????? ? ???????? ?????? ? ????????????? ?????? ???????????',
		'keywords_service'=>'?????? ????????? ???????? ?????,????????? ???????? ?????, ????????? ???????? ??????????? ?????????, ????????? ???????? ?????????, ????????? ??????, ????????? e mail ,????????? ????????? e mail,????????? ???????? e mail',
		'need_auth'=>'??? ??????? ?????????? ???????????.',
		'wronglogpas'=>'???????????? ????? ??? ??????.',
		'sendedto'=>'?????????? ?? ',
		'badcaptcha'=>'???????????? captcha',
		...
		'hellopage'=>'<center><h2>?????? ???????????</h2></center>
				<p>
					...
					<b>?????? ????????? ???????? ????? ????????? ?????????</b> ? ?????????? ? ?????? ????? ? ???????????????? ?????.<br>
					<center><button class="btn btn-primary btn-large prime-button">????????? ??????</button></center>					
				</p>
				<p>
					????????? ?????? ??????? ????????? ???????? ??? ????????? ?? ????? ??????? ????? <b>?????? ?? 25$ ??? 750 ??????</b>.
					<br>? ??? <b>??????????? ??? ???????????</b> ?? ????????, ? ??????????????:<br>
					...
					<center><a href="/buy/" class="btn btn-primary btn-large prime-button" style="color:#fff;font-weight:bold;">??????</a></center>
				</p>
				<p>
					? ??????????? ?????????? <b>?????????????? ??????????? ?????????</b>, ???? ??????? ????? ?????? ?? ????? ??????????? ??????,
					?? ????????? <b>50% ?? ?????????</b> ??????? (12.5$ ??? 325 ??????) ? ?????? ???????.<br>
					<center><a href="/partner/" class="btn btn-primary btn-large prime-button" style="color:#fff;font-weight:bold;">????? ?????????!</a></center>
				</p>
		        ...
		        <div data-description="?????? ????????? ???????? ??????????? ????? ? ???????? ?????? ? ????????????? ?????? ???????????" data-title="?????? ????????? ???????? ????? ? ???????? ?????? - ???????????" data-url="http://mailer.a-l-e-x-u-s.ru/" class="pluso" data-options="big,square,line,horizontal,counter,theme=08" data-services="vkontakte,odnoklassniki,facebook,twitter,google,moimir,email,print" data-background="#ebebeb"></div>
		...
		'helppage'=>'<h2>???????</h2>
				<h3>??? ????</h3>
				?????? ????????? ???????? email ????????? ? ?????????????/?????? ?????? ? ????????? ??? html ???????.<br>
				<b>?????? html(e)</b> ????????? ????????????? ????????? ? attach ???????? ?? ????? img ??? ???????? background, ??? ?????? ?????? ?????????? ? ?? ??????? ???????? ??????? ??? ??????????? ???????????. 
				??? ?? ? ???????? ???????? (the bat, outlook, ...) ???????? ???????????? ?????.<br>
				<b>esreveR</b> ?????? ??????? ? ???????? ??????? ? ????????????? css ??? ?? ??????????? ? ?????? ???????.<br>
				<b>????????????</b> ????????? ?????????? ??? ????? ????????? ?????? ????? ??? ??????? ????? ????????.<br>
				<b>??????????\???????</b> ????????? ????????? ????? ? ?????? ??????? ??? ????? ???????????? ?????.<br>
				<b>????????? ??????</b> ????????? ???????? ???????? ?? ?????? ????? ? ?????. ?????.<br>
				<b>????????</b> ????? ????????? ?????<br>
				<b>??????? ???????</b> ??? ????????????? ???????? ????? ??????? ????????????? <br><b style="color:red;">????? ?????????????? ??????? ????????? ????????? ???????????? ?? ?????? ?? ???????</b>
				<br><br><a href="http://mailer.a-l-e-x-u-s.ru/docs/alexusMailer_v1.7.ru.pdf"><span class="label label-warning"><i class="icon-file icon-white"></i> ??????? ?????? ????????????</span></a>
				<hr>
				<h3>??????? (? ???? ?????? ? ? ??????????)</h3>
				<ul>
					<li>???? - <b>[TO-EMAIL]</b></li>
					<li>?? ????, ??? - <b>[FROM-NAME]</b></li>
					<li>?? ????, ????? email - <b>[FROM-EMAIL]</b></li>
					<li>???? - <b>[THEME]</b></li>
					<li>?????????????? ???? - <b>[ADD0]</b> , <b>[ADD1]</b>, <b>[ADD2]</b> ...</li>
					<li>????????? ????? (5000..6000)- <b>[RAND]</b></li>
					<li>????????? ????? (?? A ?? B)- <b>[RAND-A-B]</b> , ???????? <b>[RAND-10-99]</b></li>
					<li>????????? ????? - <b>[RAND:text1|text2|...]</b> , ???????? <b>[RAND:hello dude|hello|hi|wazzup]</b></li>
					<li>???????????? - <b>[ENUM:text1|text2|...]</b> , ???????? <b>[ENUM:????????????|??????|??? ????]</b></li>
				 </ul>
				 <h3>??????? ???? ? ???????</h3>
				 <ul>
				 	<li><b>[DATE]</b> - ??????? ???? (<b>[DATE-4]</b> - ??????? ???? ????? 4 ???) (<b>[DATE+4]</b> - ??????? ???? ???? 4 ???)
				 		<ul>
				 			<li><b>[DAY]</b> - ??????? ???? (<b>[DAY+3]</b> - ??????? ???? ???? 3 ???)</li>
				 			<li><b>[MONTH]</b> - ??????? ????? (<b>[MONTH-2]</b> - ??????? ????? ????? 2 ??????)</li>
				 			<li><b>[YEAR]</b> - ??????? ??? (<b>[YEAR-1]</b> - ??????? ??? ????? 1 ???)</li>
				 		</ul>
				 	</li>
				 	<li><b>[TIME]</b> - ??????? ????? (<b>[TIME-4]</b> - ??????? ????? ????? 4 ??????)
				 		<ul>
				 			<li><b>[HOUR]</b> - ??????? ??? (<b>[HOUR-3]</b> - ??????? ??? ????? 3 ????)</li>
				 			<li><b>[MINUTE]</b> - ??????? ????? (<b>[MINUTE-2]</b> - ??????? ?????? ????? 2 ??????)</li>
				 		</ul>
				 	</li>
				 </ul>
				<hr>
...
function pingout_server() {
	...
	$.post('<?php print $_SERVER['PHP_SELF'];?>?pingoutserver',{server:server}, function(data) {
		...
		if(result.status=="GOOD") {
			$("#pingout_log").html(log+"<span style='color:green;'>"+result.server+" ????????</span><br>");
			$("#out_servers").val($("#out_servers").val()+result.server+"\n");
		} else {
			$("#pingout_log").html(log+"<span style='color:red;'>"+result.server+" ??????: "+result.error+"</span><br>");
		}
			...
			<div class="well">
			    ...
			    <div class="tab-content">
					...
					<div class="tab-pane" id="outservers-tab">
						...
						<br>
						<textarea id="out_servers" style="width:100%; height:250px;" placeholder="??????: http://serv4.ru/sw.php|c99|login:password"></textarea><br>
